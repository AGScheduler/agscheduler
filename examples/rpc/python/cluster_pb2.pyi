...
class Node(_message.Message):
    __slots__ = ["main_endpoint", "endpoint", "endpoint_grpc", "endpoint_http", "queue", "mode", "health", "register_time", "last_heartbeat_time"]
    MAIN_ENDPOINT_FIELD_NUMBER: _ClassVar[int]
