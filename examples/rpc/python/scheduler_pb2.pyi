...
class Job(_message.Message):
    __slots__ = ["id", "name", "type", "start_at", "end_at", "interval", "cron_expr", "timezone", "func_name", "args", "timeout", "queue", "last_run_time", "next_run_time", "status"]
    ID_FIELD_NUMBER: _ClassVar[int]
